...
from nerfstudio.models.gaussian_NeRF import GaussianNeRFModelConfig
...
descriptions = {
    ...
    "gaussian-NeRF":"SDF approximation through discrete Randomized Smoothing"
}

method_configs["gaussian-NeRF"] = TrainerConfig(
    method_name="gaussian-NeRF",
    ...
    pipeline=DynamicBatchPipelineConfig(
        ...
        model=GaussianNeRFModelConfig(eval_num_rays_per_chunk=8192),
    ),
    optimizers={
        "fields": {
